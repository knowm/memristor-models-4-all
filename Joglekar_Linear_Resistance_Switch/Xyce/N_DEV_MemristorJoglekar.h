...
#ifndef Xyce_N_DEV_MemristorJoglekar_h
#define Xyce_N_DEV_MemristorJoglekar_h
...
// sensitivity functor
// not yet implemented.
class MemristorJoglekarSensitivity : public baseSensitivity
{
  public:
  MemristorJoglekarSensitivity() : 
    baseSensitivity() {};

  virtual ~MemristorJoglekarSensitivity() {};
...
//-----------------------------------------------------------------------------
// Class         : Xyce::Device::MemristorJoglekar::Instance
// Purpose       :
// Special Notes :
...
//-----------------------------------------------------------------------------
//
// MemristorJoglekar device instance class.
//
...
class Instance : public DeviceInstance
{
  ...
  friend class Traits;
  friend class Master;
  friend class MemristorJoglekarSensitivity;
...
public:
  ...
  //---------------------------------------------------------------------------
  // Function      : Xyce::Device::MemristorJoglekar::Instance::getModel
  // Purpose       : destructor
  // Special Notes :
  // Scope         : public
  // Creator       : Richard Schiek, Electrical Models & Simulations
  ...
  //
  // @return reference to the owning MemristorJoglekar::Model
  //
...
//---------------------------------------------------------------------------
// Function      : Xyce::Device::MemristorJoglekar::Instance::jacobianStamp
// Purpose       :
// Special Notes :
// Scope         : public
// Creator       : Richard Schiek, Electrical Models & Simulations
...
private:
  static std::vector< std::vector<int> >  jacStamp; //< All MemristorJoglekar instances have a common Jacobian Stamp
...
//-----------------------------------------------------------------------------
// Class         : Xyce::Device::MemristorJoglekar::Model
// Purpose       :
// Special Notes :
// Creator       : Richard Schiek, Electrical Models & Simulations
// Creation Date : 10/23/2014
...
public:
  ...
  //---------------------------------------------------------------------------
  // Function      : Xyce::Device::MemristorJoglekar::Model::addInstance
  // Purpose       :
  // Special Notes :
  // Scope         : public
  // Creator       : Richard Schiek, Electrical Models & Simulations
...
private:
  ...
  // model parameters for Joglekar model
...
//-----------------------------------------------------------------------------
// Class         : Xyce::Device::MemristorJoglekar::Master
// Purpose       :
// Special Notes :
// Creator       : Richard Schiek, Electrical Models & Simulations
// Creation Date : 10/23/2014 
...
//
// For efficiency, the MemristorJoglekar class reimplements these methods to do the
...
public:
  ...
  //---------------------------------------------------------------------------
  // Function      : Xyce::Device::MemristorJoglekar::Master::Master
  // Purpose       :
  // Special Notes :
  // Scope         : public
  // Creator       : Richard Schiek, Electrical Models & Simulations
  ...
  //---------------------------------------------------------------------------
  //
  // Construct a MemristorJoglekar Device.
  //
  // @param configuration
  // @param factory_block
  // @param solver_state
...
#endif // Xyce_N_DEV_MemristorJoglekar_h
